<x-app>
    <form method="post" action="/profiles/{{ $user->username }}" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            <label class="block mb-2 uppercase font-bold text-gray-700" for="avatar">
                Avatar
            </label>
            <div class="flex">
                <input class="border border-gray-400 p-2 w-full"
        ...
        <div class="mb-6">
            <label class="block mb-2 uppercase font-bold text-gray-700" for="password_confirmation">
        ...
        <div class="mb-6">
            ...
            <a href="/profiles/{{ auth()->user()->username }}" class="hover:underline">Cancel</a>
        </div>
